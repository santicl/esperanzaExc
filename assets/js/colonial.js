...
const readSend = () => {
    document.getElementById('btnSubmit').addEventListener('click', () => {
        ...
        const URL = 'https://api.whatsapp.com/send?phone=573002518619&text=Deseo%20apartar%20un%20cupo%20con%20' + name1 + '%20y%20' + name2 + '%20para%20' + turn + '%20para%20el%20dia%20' + document.getElementById('day').value;
